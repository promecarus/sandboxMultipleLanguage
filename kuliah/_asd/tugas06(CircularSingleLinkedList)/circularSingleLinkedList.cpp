...
void CetakCircularSingleLinkedList() {
	...
	if(head == NULL) {			// jika list kosong, maka buat node pertama
		...
		cout << setfill('-') << setw(7) << left << "+-" << setw(32) << left << "+-" << setw(17) << left << "+-" << setw(17) << left << "+-" << setw(17) << left << "+-" << setw(17) << left << "+-" << "+\n";
		cout << setfill(' ') << "| " << left << setw(5) << "ID" << "| " << left << setw(30) << "Nama" << "| " << left << setw(15) << "Hobi" << "| " << left << setw(15) << "Divisi" << "| " << left << setw(15) << "Tahun Lahir" << "| " << left << setw(15) << "Tahun Masuk" << "|\n";
		do {
			cout << setfill('-') << setw(7) << left << "+-" << setw(32) << left << "+-" << setw(17) << left << "+-" << setw(17) << left << "+-" << setw(17) << left << "+-" << setw(17) << left << "+-" << "+\n";
			string namaDepanTemp = "", namaTengahTemp = " ", namaBelakangTemp = " ", namaLengkap;
			...
			cout << setfill(' ') << "| " << left << setw(5) << cur->id << "| " << left << setw(30) << namaLengkap << "| " << left << setw(15) << cur->hobiAnggota << "| " << left << setw(15) << cur->divisi << "| " << left << setw(15) << cur->tahunLahir << "| " << left << setw(15) << cur->tahunMasuk << "|\n";
