...
using namespace std;
// Buatlah sebuah double linked list, yang didalamnya terdapat nested struct
// dengan atribut yang menggunakan type data array
...
void CetakDoubleLinkedList() {
    ...
    while (cur != NULL) {
        ...
        cout << "Nama Belakang\t: " << cur->namaAnggota.namaBelakang.kata
             << "\n";
        cout << "Hobi\t\t: " << cur->hobiAnggota.hobi1.kata << " "
             << cur->hobiAnggota.hobi2.kata << " "
             << cur->hobiAnggota.hobi3.kata << "\n";
        cout << "Divisi\t\t: " << cur->divisi << "\n";
        cout << "Tanggal Lahir\t: " << cur->tanggalLahir.tanggal << " "
             << cur->tanggalLahir.bulan << " " << cur->tanggalLahir.tahun
             << "\n";
        cout << "Tanggal Masuk\t: " << cur->tanggalMasuk.tanggal << " "
             << cur->tanggalMasuk.bulan << " " << cur->tanggalMasuk.tahun
             << "\n";
        cout << "\n";
        cur = cur->next;
    }
...
int main() {
    ...
    while (pilihan != 9) {
        ...
        cout << "+-------------------------------------------------------------"
                "-------------------------------------------+"
             << "\n";
        cout << "| [1] Tambah Depan | [2] Tambah Belakang | [3] Hapus Depan | "
                "[4] Hapus Belakang | [5] Cetak | [9] Keluar |"
             << "\n";
        cout << "Pilihan: ";
        cin >> pilihan;
